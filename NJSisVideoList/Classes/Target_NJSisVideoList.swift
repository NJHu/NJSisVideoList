...
@objc class Target_NJSisVideoList: NSObject {
    ...
    @objc func Action_mainViewController(params: [String: AnyObject]) -> UIViewController? {
        ...
        childController.tabBarItem.selectedImage = UIImage.nj_image(name: "tabBar_essence_click_icon", bundleClass: Target_NJSisVideoList.self)?.withRenderingMode(UIImageRenderingMode.alwaysOriginal)
